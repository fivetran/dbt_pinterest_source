...
{{ pinterest_ads_fill_pass_through_columns(base_columns=columns, pass_through_fields=var('pinterest__ad_group_report_passthrough_metrics'), except_fields=['total_conversions', "total_conversions_quantity", "total_conversions_value_in_micro_dollar"]) }}
